...
server.registerTool(
  "manifestHighlight",
  {
    ...
    description:
      "Ephemeral Manifestation. Draws a bounded, temporary highlight over the " +
...
server.registerTool(
  "spawnPresence",
  {
    ...
    description:
      "Instanced Manifestation, step 1 of 3 (spawn / animate / retire). Creates a " +
...
server.registerTool(
  "addArtifact",
  {
    ...
    description:
      "Instanced Manifestation, step 1 of 2 (add / retire). Adds a Gaussian splat " +
...
server.registerTool(
  "animatePresence",
  {
    ...
    description:
      "Instanced Manifestation, step 2 of 3. Feeds new content (e.g. words to say) " +
...
server.registerTool(
  "retirePresence",
  {
    ...
    description:
      "Instanced Manifestation, step 3 of 3. Cleanly ends a presence created by " +
